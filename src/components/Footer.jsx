...
const socialLinks = [
  ...
  { href: "https://calendly.com/dyanabutler/meeting", label: "Schedule a Meeting With Me", icon: "M19 8h-1V6a1 1 0 00-2 0v2H8V6a1 1 0 00-2 0v2H5a2 2 0 00-2 2v8a2 2 0 002 2h14a2 2 0 002-2v-8a2 2 0 00-2-2z" },
];

const Footer = () => {
  return (
    <footer className="text-foreground py-2 border-t border w-full">
        ...
        <div className="flex flex-wrap justify-center space-x-4">
          {socialLinks.map((link, index) => (
            <a
              ...
              href={link.href}
              target="_blank"
              className="transition duration-300 hover:text-indigo-600 flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
