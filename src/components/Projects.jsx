...
export default function Projects({ setSelectedProject, selectedProject }) {
  const projects = [
    ...
    },
    {
      ...
      description: 'Nova has wares if you have coin! A fullstack e-commerce shop.',
      image: '/yarn.png',
      services: ['Full Stack Website Development', 'UI/UX Design', 'Community Engagement'],
    ...
    },
    {
      ...
      description: 'A project focused on community engagement and social impact.',
      image: '/bianchini.png',
      services: ['Website Development', 'UI/UX Design', 'Community Engagement'],
      stack: ['Next.js', 'Tailwind CSS', 'Firebase', 'Stripe API'],
      github: "https://github.com/your-project",
